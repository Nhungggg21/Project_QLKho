                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group"><label for="Ma_Nguyen_Lieu" class="form-label">Mã nguyên liệu</label>
                                                                <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="Ten_Nguyen_Lieu" name="Ma_Nguyen_Lieu" value="{{ $nguyen_lieu->Ma_Nguyen_Lieu }}" placeholder="Mã nguyên liệu" required maxlength="100"readonly>
                                                                </div>
                                                                @if ($errors)
